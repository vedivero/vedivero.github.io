      ...
      roles: [
        {
          ...
          points: [
            { text: "디지털 트윈 플랫폼의 인증·권한 체계 구축 및 공간 분석 API 개발" },
            { text: "자연어 부품 검색 파이프라인 설계 및 풀스택 개발" },
          ],
          skills: [
            "Java",
            "Spring Boot",
  ...
  projects: [
    {
      ...
      summary: "자연어 부품 검색 파이프라인 설계 및 풀스택 개발",
      techStack: [
        "Python",
        "FastAPI",
        "TypeScript",
    ...
    },
    {
      ...
      summary: "인증·권한 체계 구축 및 공간 분석 API 개발",
      techStack: [
        "Java",
        "Spring Boot",
        "Spring Security",
      ...
      points: [
        { text: "JWT 인증 체계 구축 및 MOMRA SSO 연동" },
        { text: "조직·역할 기반 메뉴·레이어 동적 권한 제어 구현" },
        {
          text: "사우디 정부 API 3종 연동 (Balady OAuth 2.0, Meteomatics, Mumtathil)",
          children: [{ text: "외부 API 호출 실패에 대비한 토큰 캐싱 적용으로 안정성 확보" }],
        },
        { text: "PostGIS 기반 건축법 위반 탐지 REST API 개발" },
        { text: "Cesium 기반 3D 뷰어 및 위반 지점 시각화 구현" },
      ],
    },
    {
      period: "",
      title: "울산 신불산 야영장 결제 모듈 교체",
      summary: "레거시 PG 전환 및 결제 데이터 구조 정비",
      link: "https://camping.ulju.ulsan.kr/",
      techStack: ["Java", "Spring", "전자정부 표준프레임워크", "MyBatis", "MySQL", "JEUS"],
      points: [
        {
          text: "기존 XPay 결제 시스템을 Toss Payments로 교체",
          children: [
            { text: "결제 요청·승인·취소 전 구간 연동 및 결제 데이터 처리" },
            { text: "결제 수단 확대에 따른 기존 데이터 구조 정비" },
          ],
        },
        { text: "JEUS(TMAX) 기반 국산 WAS 환경에 배포" },
      ],
    },
    {
      period: "",
      title: "경상남도 스마트 공간정보 시스템 — 공유재산 관리",
      summary: "지도 서비스 응답 속도 개선 및 공간 분석 기능 개발",
      ...
      points: [
        ...
        {
          text: "공유재산·국유재산 데이터 조회 및 지도 시각화 기능 개발",
          children: [
            { text: "PostGIS 기반 공간 데이터 처리" },
            { text: "QGIS로 지도 레이어를 제작해 GeoServer에 빌드 후 서비스 호출·적용" },
          ],
        },
        { text: "OpenLayers 기반 공간 데이터 표출" },
      ],
    },
    {
      period: "",
      ...
      points: [
        { text: "도시재생 데이터 조회·시각화 및 지도 조작 기능 개발" },
    ...
    },
    {
      ...
      summary: "위치 기반 자원 조회 및 실시간 알림 발송 개발",
      techStack: [
        "Java",
        "Spring",
        "전자정부 표준프레임워크",
      ...
      points: [
        {
          ...
          children: [{ text: "반경 계산 기반 인근 소방서 조회" }],
        },
    ...
    },
    {
      ...
      techStack: ["Java", "Spring", "전자정부 표준프레임워크", "iBatis", "Oracle", "CentOS"],
      points: [
